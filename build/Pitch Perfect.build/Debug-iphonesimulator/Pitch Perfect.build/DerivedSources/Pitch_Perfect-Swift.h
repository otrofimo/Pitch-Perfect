...
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified tapToRecord;
...
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithFilePathUrl:(NSURL * __nonnull)filePathUrl title:(NSString * __nonnull)title OBJC_DESIGNATED_INITIALIZER;
@end
